...
            {/* Facebook */}
            <a href="https://www.facebook.com/Mariseny.moves/" target="_blank" rel="noopener noreferrer">
              <img src={assets.facebook_icon} alt='Facebook' width={35} className='cursor-pointer invert dark:invert-0' />
            </a>

            {/* Twitter */}
            <a href="https://x.com/MAlisenichavula/" target="_blank" rel="noopener noreferrer">
              <img src={assets.twitter_icon} alt='Twitter' width={35} className='cursor-pointer invert dark:invert-0' />
            </a>

            {/* Instagram */}
            <a href="https://www.instagram.com/malisenichavula/" target="_blank" rel="noopener noreferrer">
              <img src={assets.instagram_icon} alt='Instagram' width={35} className='cursor-pointer invert dark:invert-0' />
            </a>

            {/* LinkedIn (New) */}
            <a href="https://www.linkedin.com/in/maliseni-chavula-7100b323b" target="_blank" rel="noopener noreferrer">
